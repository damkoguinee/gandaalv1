                ...
                if ($_POST['montant']<0){?>
                    ...
                    if ($_POST['montant']!="") {
                        ...
                        if (empty($dateop)) {
                            ...
                            $DB->insert('INSERT INTO banqueresto (id_banque, montant, libelles, numero, date_versement) VALUES(?, ?, ?, ?, now())', array($_POST['compte'], -$_POST['montant'], "Retrait(".$_POST['coment'].')', 'retd'.$numdec));
                        }else{
                            ...
                            $DB->insert('INSERT INTO banqueresto (id_banque, montant, libelles, numero, date_versement) VALUES(?, ?, ?, ?, ?)', array($_POST['compte'], -$_POST['montant'], "Retrait(".$_POST['coment'].')', 'retd'.$numdec, $dateop));
