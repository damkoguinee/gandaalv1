        ...
        if (!isset($_GET['termeliste'])) {
          ...
          if (isset($_GET['terme'])) {
            ...
            if (!empty($_SESSION['terme'])) {
              ...
              $products = $DB->query("SELECT * FROM stock WHERE genre='{$genre}' order by(nom) LIMIT 50");
            }
          }
        }else{
        ...
        if (!empty($products)) {
          ...
          foreach ($products as $key=> $product){
            ...
            <tr>
              ...
              <form action="approvisionaromes.php" method="POST">
    ...
    $(document).ready(function(){
        $('#search-user').keyup(function(){
            ...
            if (utilisateur!='') {
                $.ajax({
                    type: 'GET',
                    url: 'rechercheproduit.php?approaromes',
