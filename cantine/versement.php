      ...
      if (isset($_POST["client"])) {
        ...
        if ($_POST["client"]=='' OR $_POST["montant"]=='') {
          ...
          if (empty($dateop)) {
            ...
            $DB->insert('INSERT INTO versementresto (numcmd, nom_client, montant, motif, type_versement, comptedep, date_versement) VALUES(?, ?, ?, ?, ?, ?, now())', array('dep'.$max, $_POST['client'], $_POST['montant'], $_POST['motif'], $_POST['mode_payement'], $_POST['compte']));

          }else{

            $DB->insert('INSERT INTO versementresto (numcmd, nom_client, montant, motif, type_versement, comptedep, date_versement) VALUES(?, ?, ?, ?, ?, ?, ?)', array('dep'.$max, $_POST['client'], $_POST['montant'], $_POST['motif'], $_POST['mode_payement'], $_POST['compte'], $dateop));
          }
          ...
          if (empty($dateop)) {
            ...
            $DB->insert('INSERT INTO banqueresto (id_banque, montant, libelles, numero, date_versement) VALUES(?, ?, ?, ?, now())', array($_POST['compte'], $_POST['montant'], "Depot(".$_POST['motif'].')', 'dep'.$max));
          

            if ($client['type']=='Banque') {

              $DB->insert('INSERT INTO banqueresto (id_banque, montant, libelles, numero, date_versement) VALUES(?, ?, ?, ?, now())', array($client['id'], -$_POST['montant'], "Retrait(".$_POST['motif'].')', 'dep'.$max));
            }
            ...
            $DB->insert('INSERT INTO banqueresto (id_banque, montant, libelles, numero, date_versement) VALUES(?, ?, ?, ?, ?)', array($_POST['compte'], $_POST['montant'], "Depot(".$_POST['motif'].')', 'dep'.$max, $dateop));
          

            if ($client['type']=='Banque') {

              $DB->insert('INSERT INTO banqueresto (id_banque, montant, libelles, numero, date_versement) VALUES(?, ?, ?, ?, ?)', array($client['id'], -$_POST['montant'], "Retrait(".$_POST['motif'].')', 'dep'.$max, $dateop));
            }
          }
        ...
        <table class="payement">
          ...
          <tbody><?php 
            ...
            if (isset($_POST['j1'])) {
              ...
              $products= $DB->query('SELECT versement.id as id, client.id as idc, numcmd, client.nom_client as nom_client, montant, motif, type_versement, date_versement FROM versementresto inner join client on client.id=versement.nom_client  WHERE YEAR(date_versement) = :annee order by(versement.nom_client) LIMIT 50', array('annee' => date('Y')));
            }
