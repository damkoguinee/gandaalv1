...
class Rapport
{
	...
	public function bilanEffectifRemise($cursus, $etat, $promo){
		...
		$prod=$this->DB->querys("SELECT count(id) as nbre FROM inscription inner join payementresto on payement.matricule=inscription.matricule where niveau='{$cursus}' and etat='{$etat}' and remise='{$remise}' and annee='{$promo}' and promo='{$promo}'");
	...
	public function bilanInscriptionApayer($cursus, $etat, $promo){
		...
		$prodsansremise=$this->DB->querys("SELECT count(payement.id) as nbre FROM inscription inner join payementresto on payement.matricule=inscription.matricule where niveau='{$cursus}' and motif='{$etat}' and payement.remise='{$remise}' and annee='{$promo}' and promo='{$promo}'");

		$remiseins=0;

		$prodremiseins = $this->DB->query("SELECT  montant, payement.remise as remise FROM payementresto inner join inscription on inscription.matricule=payement.matricule WHERE  niveau='{$cursus}' and motif='{$etat}' and payement.remise!='{$remiseins}' and annee='{$promo}' and promo='{$promo}'");
		...
		$prod=$this->DB->querys("SELECT sum(montant) as montant, inscription.niveau as niveau FROM payementresto inner join inscription on payement.matricule=inscription.matricule where niveau='{$cursus}' and motif='{$etat}' and annee='{$promo}' and promo='{$promo}'");
	...
	public function nbrePersonnel(){
		...
		$prod=$this->DB->querys("SELECT count(id) as nbre FROM personnelresto ");
	...
	public function salairePayePersonnel($promo){
		...
		$prodavance=$this->DB->querys("SELECT sum(montant) as salaire FROM accompte inner join personnelresto on numpers=accompte.matricule where anneescolaire='{$promo}' ");
	...
	public function inscriptionTotal($promo){
		...
		$prod=$this->DB->querys("SELECT sum(montant) as montant FROM payementresto inner join inscription on payement.matricule=inscription.matricule where annee='{$promo}' and promo='{$promo}'");
	...
	public function inscriptionTotCursus($cursus, $promo){
		...
		$prod=$this->DB->querys("SELECT sum(montant) as montant FROM payementresto inner join inscription on payement.matricule=inscription.matricule where niveau='{$cursus}' and annee='{$promo}' and promo='{$promo}'");
	...
	public function resteIns($cursus, $promo){
		...
		$prodins=$this->DB->querys("SELECT count(inscription.matricule) as nbre FROM payementresto inner join inscription on payement.matricule=inscription.matricule where motif='{$ins}' and niveau='{$cursus}' and annee='{$promo}' and montant='{$montant}' and payement.remise!='{$remise}' and promo='{$promo}' ");

		$prodreins=$this->DB->querys("SELECT count(inscription.matricule) as nbre FROM payementresto inner join inscription on payement.matricule=inscription.matricule where motif='{$reins}' and niveau='{$cursus}' and annee='{$promo}' and montant='{$montant}' and payement.remise!='{$remise}' and promo='{$promo}' ");
	...
	public function restescol($cursus, $promo){
		...
		$prodins=$this->DB->querys("SELECT count(payement.matricule) as nbre FROM payementresto inner join inscription on payement.matricule=inscription.matricule where payement.matricule not in(SELECT matricule from payementresto where promo='{$pr}') and niveau='{$cursus}' and annee='{$promo}' and montant='{$montant}' and promo='{$promo}' ");

		$prodreins=$this->DB->querys("SELECT count(payement.matricule) as nbre FROM payementresto inner join inscription on payement.matricule=inscription.matricule where payement.matricule in(SELECT matricule from payementresto where promo='{$pr}') and niveau='{$cursus}' and annee='{$promo}' and montant='{$montant}' and promo='{$promo}' ");
