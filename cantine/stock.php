          ...
          <div class="sup_prod">
            ...
            <form method="post" action="stock.php">
              ...
              if (!isset($_POST['num_cmd'])) {
                ...
                $products = $DB->querys('SELECT num_cmd FROM payementresto WHERE num_cmd=:Num', array('Num'=>$numero));
              ...
              if (!isset($_POST['num_dec'])) {
                ...
                $DB->delete('DELETE FROM decaissementresto WHERE id = ?', array($numero));

                $req = $DB->query('SELECT id FROM decaissementresto WHERE id=:ID', array('ID'=>$numero));
