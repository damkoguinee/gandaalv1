							...
							if (!isset($_GET['id'])) {?>
								...
								<div class="container">
									...
									<div class="row">
										...
										<div  class="col fw-bold fs-5 p-1 mb-1 text-white text-center m-auto rounded" style="background-color: #2C1A6C">QUE VOULEZ-VOUS COMMME AROME ?</div>
											
										<div class="container-fluid">

											<div class="row"><?php

												$products = $DB->query('SELECT * FROM stock WHERE genre="aromes" and quantity>0 order by(quantity)desc');
												
												foreach ($products as $plat){?>

													<div class="col pb-2">

										        		<a style="text-decoration: none" href="<?=$positionmodif;?>?nom=<?=$plat->nom; ?>&idc=<?=$plat->id;?>&pv=<?=0;?>&addplat&type=<?='Nos Chichas';?>">
											            	<div class="card m-auto border-10 border-primary" style="width: 9rem; height: 150px;">
											                	...
											                	<img src="css/img/plat/<?= $plat->id; ?>.jpg" class="card-img-top m-auto" alt=" " style="width: 5rem; height: 4rem">
																...
																<div class="card-bod m-auto">
												              		<h5 class="card-title text-center text-danger">Inclus</h5>
												            	</div>
